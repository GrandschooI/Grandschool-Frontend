    ...
    <div className={cn(s.notMainPageWrapper, s[themeStyle ? themeStyle : ''])}>
      <div className={'container'}>
        <nav className={cn(s.headerNav, s.notMainPage)}>
          ...
          <NavLink to='/about-us/project' className={cn(s.headerNavLink, location.includes('/about-us') ? s.headerActiveNavLink : '')}>
            <span className={s.headerNavLinkLabel}>O nas</span>
          </NavLink>
          <NavLink to='/course' className={cn(s.headerNavLink, location.includes('/course') ? s.headerActiveNavLink : '')}>
