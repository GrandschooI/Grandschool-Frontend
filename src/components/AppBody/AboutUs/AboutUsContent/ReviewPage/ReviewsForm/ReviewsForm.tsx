...
import {
  sendFeedbackReviewsThunkCreator,
  sendFeedbackType,
      ...
      {({ isSubmitting, handleChange, values, errors, touched }) => (
        <Form className={s.reviewForm}>
          ...
          <ul className={s.assesmentRadioList}>
            <ReviewsAssessmentList
              statusAssessment={statusAssessment}
              setStatusAssessment={setStatusAssessment}
            />
          </ul>
          ...
          <label className={s.textareaWrap}>
            ...
            <textarea
              className={touched.text && errors.text ? 'errorTextField' : ''}
              name={'text'}
...
- What you liked best, would you recommend our course to your friends?"
          ...
          <div className={s.buttonWrapper}>
            ...
            <button
              ...
              className={cn(s.sendFeedback, 'submitBtn')}
            >
              Send Feedback
            </button>
          </div>
