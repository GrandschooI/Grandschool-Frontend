    ...
    >
      <div className={'container'}>
        <h2 className={s.featureMainTitle}>
          Kursy obsługi komputera <br /> <strong>dla osób starszych</strong>
        </h2>
        <p className={s.featureDesc}>
          Chcesz zapoznać swoich bliskich ze światem technologii internetowych? <br />
          Zależy Ci, aby dostosować ich do szybko zmieniającej się rzeczywistości? <br />
          Sympatyczni i wysoko wykwalifikowani specjaliści GrandSchool nauczą Twoją rodzinę
          wszystkich <br />
        ...
        <ul className={cn(s.newsList)}>
          <li className={s.newsItem}>
            <div className={s.newsPhotoWrap}>
              {images && (
                <Image className={s.newsPhoto} src={time} webp={timeWebp} alt="Brak czasu" />
              )}
            </div>
            <div className={s.newsDescBlock}>
              <h3 className={s.newsItemTitle}>Czasu</h3>
              <p className={s.newsDescription}>
                Gdy Ty rozwiązujesz codzienne problemy i nie masz czasu, aby uczyć swoich bliskich
                obsługi komputera i internetu, my zrobimy to za Ciebie!
              </p>
            </div>
          </li>
          <li className={s.newsItem}>
            <div className={s.newsPhotoWrap}>
              {images && (
                <Image className={s.newsPhoto} src={teach} webp={teachWebp} alt="Zły nauczyciel" />
              )}
            </div>
            <div className={s.newsDescBlock}>
              <h3 className={s.newsItemTitle}>Umiejętności dydaktycznych</h3>
              <p className={s.newsDescription}>
                Znakomity programista, to nie koniecznie dobry mentor. Niech każdy robi swoje - my
                bierzemy na siebie trud uczenia, a Ty cieszysz się z postępów swoich najbliższych.
              </p>
            </div>
          </li>
          <li className={s.newsItem}>
            ...
            <div className={s.newsDescBlock}>
              ...
              <p className={s.newsDescription}>
                Wyjaśnienie podstaw obsługi komputera osobom starszym wymaga dużo energii i
                zaangażowania. W GrandSchool wiedzę przekazujemy łatwo i bez ciężaru emocjonalnego
              </p>
            </div>
          </li>
        </ul>
