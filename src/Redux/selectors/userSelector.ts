...
export const getUserEmail = (state: AppStateType): Nullable<string> => state.userData.currentUser.email
export const getUserCity = (state: AppStateType): Nullable<string> => state.userData.currentUser.city
export const getAboutUserText = (state: AppStateType): Nullable<string> => state.userData.currentUser.description
export const getUserPhotoLink = (state: AppStateType): Nullable<string> => state.userData.currentUser.photo
export const getUserAsideItems = (state: AppStateType): AsideItemsType => state.userData.asideMenuItems
